...
class CreateInput:
    def __init__(self, parent_frame, text: str, width: int):
        ...
        self.__entry: tk.Entry = tk.Entry(parent_frame, width=width, justify="center", bg=Color.create_entry_bg, fg=Color.create_entry_fg, textvariable=self.input_value)
    ...
    def grid(self, label_row: int, column: int, sticky: str):
        ...
        self.__entry.grid(row=label_row, column=column + 1, sticky=sticky, padx=(0, 10), pady=20)
