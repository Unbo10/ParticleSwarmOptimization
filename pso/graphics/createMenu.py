...
class CreateMenu:
    def __init__(self, master_frame, initialize_window: callable, change_menu: callable, optimization_history: list[Optimization], window_width: int, window_height: int):
        ...
        self.__back_button: BackButton = BackButton(self.root, image_path="assets/arrow-back.png", active_image_path="assets/arrow-back-active.png", width=self.__title_height * 25, height=self.__title_height * 25, change_menu=change_menu, change_menu_args={"menu_name": "main"})
        ...
        self.__particle_amount: CreateInput = CreateInput(self.__inputs_frame, text="Particle amount", width=entry_width)
        self.__iterations: CreateInput = CreateInput(self.__inputs_frame, text="Iterations", width=entry_width)
        self.__inputs: list[CreateInput] = [self.__w_coefficient_input, self.__cog_coefficient_input, self.__soc_coefficient_input, self.__function_option, self.__particle_amount, self.__iterations]
    ...
    def display_graph(self, option: str):
        ...
        self.__plot_canvases[option].pack(fill="x", expand=True, anchor="ne", side="right", padx=10, pady=(10, 100))
    ...
    def display(self):
        ...
        self.__buttons_frame.pack(fill="both", expand=True, anchor="se", side="right")
